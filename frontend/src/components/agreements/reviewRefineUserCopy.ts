...
/** @deprecated Pro card uses {@link ProConversionComparisonCard} columns. */
export const STARTER_PRO_REFINE_IMPROVEMENT_BULLETS = PRO_UPGRADE_PRO_BULLETS;
...
export const STARTER_PRO_REFINE_EDIT_DRAFT_CTA = PRO_CTA_EDIT_FREE_DRAFT;
