...
export function mergeLiveSignerMetadataUiWithDomCommit(
  ...
  let partySignerNames = mergeSignerRow(ui.partySignerNames, 0, readVisiblePaidProSignerMetadataDomValue("r1-signer-name"));
  partySignerNames = mergeSignerRow(partySignerNames, 1, readVisiblePaidProSignerMetadataDomValue("r2-signer-name"));

  let partySignerTitles = mergeSignerRow(ui.partySignerTitles, 0, readVisiblePaidProSignerMetadataDomValue("r1-signer-title"));
  partySignerTitles = mergeSignerRow(partySignerTitles, 1, readVisiblePaidProSignerMetadataDomValue("r2-signer-title"));

  let partyAddresses = mergeSignerRow(ui.partyAddresses, 0, readVisiblePaidProSignerMetadataDomValue("r1-party-address"));
  partyAddresses = mergeSignerRow(partyAddresses, 1, readVisiblePaidProSignerMetadataDomValue("r2-party-address"));
...
export function buildPaidProSignerMetadataAuthorityForFinalize(
  ...
  return buildLivePaidProSignerMetadataAuthority(mergeLiveSignerMetadataUiWithDomCommit(ui));
}
