...
export type ProReviewSigningFlowPanelProps = {
  ...
  showReviewComparisonActions?: boolean;
  className?: string;
};
...
export function ProReviewSigningFlowPanel({
  ...
  showReviewComparisonActions = false,
  className = "",
    ...
    return (
      ...
      >
        ...
        <p className="mt-1 text-xs leading-relaxed text-stone-600 sm:text-sm">
          Read the agreement, copy it, or add signers when you are ready to prepare signature links.
        </p>
        ...
        {canSuggestEdits && suggestEditsOpen ? (
          ...
          >
            ...
            <p className="mt-1 text-[11px] leading-relaxed text-stone-600">
              Type notes for LawDog to apply before signature setup.
            </p>
            <textarea
  ...
  return (
    ...
    >
      ...
      <div className="mt-3 flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center">
        ...
        {!showEditedActions && showReviewComparisonActions ? (
          <button
            type="button"
